<div class="content-des_internationl">
    ...
    <div class="_fcreverse">
        <h2 class="text-location_check">{{ $publicacion->location }}</h2>
        ...
        <div class="content-publish_icon">
            ...
            <div class="favorite_icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="27.003" height="23.878"
                    viewBox="0 0 27.003 23.878" class="i">
                    <g transform="translate(1.002 -1.245)" fill="rgba(222,222,222,0.38)" stroke="#ff5a5f"
                        stroke-width="2">
                        <path
