                    ...
                    <div class="modal_block">
                        <div class="wh-p100 ht-fc pd-b13">
                            ...
                            <div class="trips_upcoming_inf">
                                <div class="bk-icon-des">
                                    <div class="bk-icon-des_fbas fx-ai-b gp10 mnw-p47">
                                        <a href="https://google.cl/maps/place/{{ $reservation['maps'] }}"
                                            class="btn-bd-white wh-p100">
                                            <div class="fx fx-ai-c fx-jc-sb">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="5.298" height="9.266"
                                                    viewBox="0 0 5.298 9.266">
                                                    <path
                                    ...
                                    <div class="bk-icon-des_fbas fx-ai-b gp10 mnw-p47">
                                        <a href="{{ route('messageUserIndex', ['interna' => $reservation['listing_id']]) }}"
                                            class="btn-bd-white wh-p100">
                                            <div class="fx fx-ai-c fx-jc-sb">
                                                <div class="flex gp12">
                                                    <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                        width="19.209" height="19.209" viewBox="0 0 19.209 19.209">
                                                        <path
                            ...
                            <div class="trips_upcoming_inf">
                                ...
                                <div class="fx fx-fd-c gp18">
                                    ...
                                    <div>
                                        <div class="bk-icon-des">
                                            <div class="bk-icon-des_fbas fx-ai-b gp10 mnw-p47">
                                                <button wire:click="sharePDF" type="button"
                                                    class="btn-bd-white wh-p100 clickGetPDF">
                                                    <div class="fx fx-ai-c fx-jc-sb">
                                                        <div class="flex gp12">
                            ...
                            <div class="trips_upcoming_inf">
                                ...
                                <div class="fx fx-fd-c mr-t21 mr-b17 gp8">
                                    ...
                                    <div>
                                        <p class="_txtec16 _txtcapit" id="address_one">
                                            {{ $reservation['street'] ?? '' }} {{ $reservation['city'] ?? '' }}</p>
                                        <p class="_txtec16 _txtcapit" id="address_two">
                                            {{ $reservation['state'] ?? '' }}, {{ $reservation['zip_code'] ?? '' }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="trips_upcoming_inf">
                                <h2 class="h2-guests title mr-b4">Your Host, <span
                                        class="_txtcapit">{{ $reservation['host_name'] }}</span></h2>
                                    ...
                                    <div class="fx fx-fd-c gp17">
                                        <div class="fx fx-ai-c fx-jc-sb gp23">
                                            <div class="fx fx-fd-c gp8">
                                                ...
                                                <div>
                                                    <p class="_txtec16">Your company and is travel partners will have
                                                    </p>
