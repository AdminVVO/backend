                ...
                <div class="modal_block">
                    <div class="content_hidden-anhost">
                        <div class="site-content reservation-details-cont" style="padding-bottom: 21px;">
                            <input type="radio" value="0" class="dn" id="radioStarCleanliness">
                            <input type="radio" value="1" class="dn" id="radioStarCommunication">
                            <input type="radio" value="2" class="dn" id="radioStarObservanceHouseRules">
                            ...
                            <div class="_flex_users hr">
                                ...
                                <div class="_b">
                                    ...
                                    <h2 class="h2-guests _txtcapit">laura jone</h2>

                                    <div class="mr-t16">
                                        <p class="_txtec _txtcapit">Dec 17 - 22, 2021</p>
                            ...
                            <div class="_block-privatenote hr">
                                <label for="labelPublicReview">
                                    <div class="mr-b24">
                                        ...
                                        <p class="_txtec16 mr-t10">Write a fair, honest review about Guillermo's stay so future hosts know what to expect.</p>
                                    </div>

                                    <textarea placeholder="Leave a comment that only Laura can read" rows="5" class="_txta-modls" id="labelPublicReview" style="resize: vertical;"></textarea>
                                </label>
                            </div>
                            ...
                            <div class="_block-privatenote hr">
                                <label for="labelPrivateNote">
                                    <div class="mr-b24">
                                        ...
                                        <p class="_txtec16 mr-t10">Offer suggestions, or say thanks for being a great guest. We won't publish your note on Guillermo's profile.</p>
                                    </div>

                                    <textarea placeholder="Add a private note (optional)" rows="5" class="_txta-modls" id="labelPrivateNote" style="resize: vertical;"></textarea>
                                </label>
                            </div>
                            ...
                            <div class="_block-privatenote hr">
                                ...
                                <div class="_txtec mr-t10">Did Guillermo leave your space clean?</div>

                                <div class="star_rating_vvo fx fx-fd-c gp8 mr-t10">
                            ...
                            <div class="_block-privatenote hr">
                                ...
                                <div class="_txtec mr-t10">How clearly did Guillermo communicate their plans, questions, and concerns?</div>
                            ...
                            <div class="_block-privatenote hr">
                                ...
                                <div class="_txtec mr-t10">Did Guillermo observe your house rules?</div>
                            ...
                            <div class="_block-privatenote hr">
                                <h2 class="h2-guests">Would you host Guillerno again?</h2>

                                <div class="_txtec mr-t10">We won't publish your answer anywhere, and Guillermo won't see it.</div>

                                <div class="fx fx-fw-w" style="gap: 11px; margin-top: 10px;">
                                ...
                                <div class="mr-t31">
                                    <button class="btn-celest">Submit review</button>
                                </div>
                            </div>
                        </div>
                    </div>
