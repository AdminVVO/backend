<div class="container_admin-host _ntñsfts container_tsptpp1" wire:ignore.self>
                    ...
                    <div class="content_hidden-anhost" id="seleccion-print" style="margin-bottom: 0; padding-bottom: 30px;">
                        <div class="reservation-details-cont">
                            ...
                            <div class="_block-about hr">
                                <h2 class="h2-guests _txtcapit mr-b10">About {{$data['name']}}</h2>
                                ...
                                <div class="_flex">
                                    <div class="_dfgap10">
                                        ...
                                        <div class="_flex-icons" style="align-items: center;">
                                            <div class="_w">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17.595" height="15.002" viewBox="0 0 17.595 15.002">
                                    ...
                                    <div style="text-align: center;">
                                        ...
                                        <p class="_txtec" style="margin-top: 19px;">Phone: +1 987 987 987</p>
                                    </div>
                                </div>
                            </div>

                            <div class="_block-booking hr">
                                <h2 class="h2-guests mr-b25">Booking details</h2>
                            ...
                            <div class="_block-booking hr">
                                <div class="booking-details_icon">
                                    ...
                                    <a href="{{ route('calendarIndex') }}" class="btn-border">
                            ...
                            <div class="_block-uestpaid hr">
                                <h2 class="h2-guests mr-t30">Guest paid</h2>
                            ...
                            <div class="_block-uestpaid hr">
                                <h2 class="h2-guests mr-t30">Host payout</h2>
                            ...
                            <div class="_block-privatenote hr">
                                <h2 class="h2-guests mr-b10">Private note</h2>
                                ...
                                <div>
                                    <p class="_txteh16">{{ Str::substr(print_r(str_replace("\n", '<br/>', $data['note'])), 0, -1) }}</p>
                                </div>

                                <textarea placeholder="Write a note" class="_txta-modls mr-t24 mr-b16" rows="4" wire:model.lazy="note"></textarea>

                                <button class="btn-celest" wire:click="saveNote()">Save</button>
                            </div>

                            <div class="_block-support hr">
                                <h2 class="h2-guests mr-b24">Support</h2>
                                ...
                                <div class="_flex">
                                    ...
                                    <div>
                                        <button type="button" class="txtunder__ics nrl blue">
                                            <div class="fx fx-ai-b gp5">
                            ...
                            <div class="_desurl hr">
                                ...
                                <p class="_txtec">The penalties for canceling this reservation include getting a public review the shows you canceled, paying a cancellation fee, and having the canceled nights blocked on your calendar.</p>
                            </div>

                            <div class="_block-commquest hr">
                                <h2 class="h2-guests mr-b24">Common questions</h2>
