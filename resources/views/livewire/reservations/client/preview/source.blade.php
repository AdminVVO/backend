...
<div style="margin-top: 16px;">
    ...
    <div class="content_celest_form">
        <div class="block">
            ...
            <p class="_txtec">{{ $content['request'] }}</p>
        </div>
    ...
    <div class="content_celest_form content_celest_form_bg">
        ...
        <div class="block pl40">
            ...
            <p class="_txtec _txtcapit">{{ $content['city'] }}</p>
        </div>
    </div>
    ...
    <div class="content_celest_form">
        <div class="block">
            ...
            <p class="_txtec _txtcapit">{{ $content['state_address'] }}</p>
        </div>

        <div class="block pl40">
            <span class="_txteh">Zip Code:</span>
            <p class="_txtec _txtcapit">{{ $content['zip_code'] }}</p>
        </div>
    </div>
    ...
    <div class="content_celest_form">
        <div class="block">
            ...
            <p class="_txtec">{{ $content['room_type'] }}</p>
        </div>
