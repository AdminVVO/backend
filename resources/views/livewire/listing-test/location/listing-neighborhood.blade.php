<form wire:submit.prevent="SubmitNeighborhood" class="show_form_input" style="margin-top: 30px;">
    <div class="_flfpc">
        <textarea class="_txta-modls @error('inputNeighborhood') error_input @enderror" rows="4" style="height: auto; resize: vertical;" wire:model.defer="inputNeighborhood"></textarea>
        @error('inputNeighborhood')
            <div  class="_txterror">
