<div class="content_hidden-anhost" style="margin-bottom: 35px;">
    ...
    @if ( $step === 'init')
        <div class="_pdleftright35">
            <div class="site-content" style="padding: 0;">
                    ...
                    <div class="fx fx-fd-c" style="gap: 18px;">
                        <div>
                            <label class="block-lb fx-ai-c fx-jc-fs">
                                <input type="radio" name="post_coments" wire:model.defer="inputOptions" value="Edit">
                        ...
                        <div>
                            <label class="block-lb fx-ai-c fx-jc-fs">
                                <input type="radio" name="post_coments" wire:model.defer="inputOptions" value="Configuring">
                                <div class="before_check">
                                    <div class="flex-centrado" style="width: inherit;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16.693" height="12.448" viewBox="0 0 16.693 12.448">
                                            <path d="M5.67,16.781.244,11.356a.835.835,0,0,1,0-1.18l1.18-1.18a.835.835,0,0,1,1.18,0L6.26,12.65l7.828-7.828a.835.835,0,0,1,1.18,0L16.449,6a.835.835,0,0,1,0,1.18l-9.6,9.6A.835.835,0,0,1,5.67,16.781Z" transform="translate(0 -4.577)" fill="#fff"></path>
                        ...
                        <div>
                            <label class="block-lb fx-ai-c fx-jc-fs">
                                <input type="radio" name="post_coments" wire:model.defer="inputOptions" value="Adjusting">
                                <div class="before_check">
                                    <div class="flex-centrado" style="width: inherit;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16.693" height="12.448" viewBox="0 0 16.693 12.448">
                                            <path d="M5.67,16.781.244,11.356a.835.835,0,0,1,0-1.18l1.18-1.18a.835.835,0,0,1,1.18,0L6.26,12.65l7.828-7.828a.835.835,0,0,1,1.18,0L16.449,6a.835.835,0,0,1,0,1.18l-9.6,9.6A.835.835,0,0,1,5.67,16.781Z" transform="translate(0 -4.577)" fill="#fff"></path>
                        ...
                        <div>
                            <label class="block-lb fx-ai-c fx-jc-fs">
                                <input type="radio" name="post_coments" wire:model.defer="inputOptions" value="Availability">
                                <div class="before_check">
                                    <div class="flex-centrado" style="width: inherit;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16.693" height="12.448" viewBox="0 0 16.693 12.448">
                                            <path d="M5.67,16.781.244,11.356a.835.835,0,0,1,0-1.18l1.18-1.18a.835.835,0,0,1,1.18,0L6.26,12.65l7.828-7.828a.835.835,0,0,1,1.18,0L16.449,6a.835.835,0,0,1,0,1.18l-9.6,9.6A.835.835,0,0,1,5.67,16.781Z" transform="translate(0 -4.577)" fill="#fff"></path>
                        ...
                        <div>
                            <label class="block-lb fx-ai-c fx-jc-fs">
                                <input type="radio" name="post_coments" wire:model.defer="inputOptions" value="Laws">
                                <div class="before_check">
                                    <div class="flex-centrado" style="width: inherit;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16.693" height="12.448" viewBox="0 0 16.693 12.448">
                                            <path d="M5.67,16.781.244,11.356a.835.835,0,0,1,0-1.18l1.18-1.18a.835.835,0,0,1,1.18,0L6.26,12.65l7.828-7.828a.835.835,0,0,1,1.18,0L16.449,6a.835.835,0,0,1,0,1.18l-9.6,9.6A.835.835,0,0,1,5.67,16.781Z" transform="translate(0 -4.577)" fill="#fff"></path>
                        ...
                        <div>
                            <label class="block-lb fx-ai-c fx-jc-fs">
                                <input type="radio" name="post_coments" wire:model.defer="inputOptions" value="Co-host">
                                <div class="before_check">
                                    <div class="flex-centrado" style="width: inherit;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16.693" height="12.448" viewBox="0 0 16.693 12.448">
                                            <path d="M5.67,16.781.244,11.356a.835.835,0,0,1,0-1.18l1.18-1.18a.835.835,0,0,1,1.18,0L6.26,12.65l7.828-7.828a.835.835,0,0,1,1.18,0L16.449,6a.835.835,0,0,1,0,1.18l-9.6,9.6A.835.835,0,0,1,5.67,16.781Z" transform="translate(0 -4.577)" fill="#fff"></path>
                        ...
                        <div>
                            <label class="block-lb fx-ai-c fx-jc-fs">
                                <input type="radio" name="post_coments" wire:model.defer="inputOptions" value="Other">
                                <div class="before_check">
                                    <div class="flex-centrado" style="width: inherit;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16.693" height="12.448" viewBox="0 0 16.693 12.448">
                                            <path d="M5.67,16.781.244,11.356a.835.835,0,0,1,0-1.18l1.18-1.18a.835.835,0,0,1,1.18,0L6.26,12.65l7.828-7.828a.835.835,0,0,1,1.18,0L16.449,6a.835.835,0,0,1,0,1.18l-9.6,9.6A.835.835,0,0,1,5.67,16.781Z" transform="translate(0 -4.577)" fill="#fff"></path>
                ...
                <div class="fx" style="justify-content: end;" wire:click='next'>
                    <button class="btn-celest">Continue</button>
                </div>
        ...
        <div class="_pdleftright35">
            ...
            <div style="margin-bottom: 24px;">
                <label style="cursor: pointer;">
                    ...
                    <div class="_flfpc">
                        <textarea class="_txta-modls @error('inputComments') error_input @enderror" rows="2" style="height: auto; resize: vertical;" wire:model.defer="inputComments"></textarea>
                        @error('inputComments')
                            <div class="_txterror">
            ...
            <div class="checkbox-item" style="margin: 0;">
                <label class="check_click">
                    <input type="checkbox" wire:model.defer="inputBug">
            ...
            <div class="fx fx-fw-w fx-jc-sb" style="gap: 12px; margin-top: 24px;">
                <div class="_btnsmleft" wire:click="resetLivewireFeedback">
                    <i class="fas fa-angle-left"></i>
                    <span>Behind</span>
                </div>

                <button class="btn-celest" wire:click='nextComments'>Continue</button>
            </div>
        </div>
    @endif
    ...
    @if ( $step === 'finish')
        <div class="_pdleftright35">
            <h2 class="h2_publish" style="padding-bottom: 34px;">Give us all the details</h2>
