<form wire:submit.prevent="SubmitLines" class="show_form_input" style="margin-top: 30px;">
    <div class="fx fx-fd-c" style="gap: 30px;">
        <div class="_flfpc mxw576">
            <div class="txt-check-in">Fee per reservation</div>

            <label class="before_icon_input @error('inputLines') error_input @enderror">
                <span class="_txtec">$</span>
                <input type="text" class="number" wire:model.defer="inputLines">
            </label>
            @error('inputLines')
                <div  class="_txterror">
