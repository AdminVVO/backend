<div>
    <div class="_cont-payments">
        <div class="h2-guests">Payments methods</div>
        <div class="_txtec">Add a payment method using our secure payment system, then start planning your next trip.</div>
        ...
        <button class="btn-celest" wire:click="showModal()">Add payment method</button>
    </div>

    @if ( $showModal )
        <div class="container_add-payments" wire:ignore.self>
                                        ...
                                        <div class="_hiddencreditordebit">
                                            <div class="_flfpc">
                                                ...
                                                <div class="block_date">
                                                    ...
                                                    <input type="text" class="_numcard @error('last_name') error_input @enderror" wire:model.lazy="last_name">
                                                    @error('last_name')
                                                        <div  class="_txterror">
                                                            <i class="fas fa-exclamation-circle icon1"></i> 
                                                            {{ $message }}
                                            ...
                                            <div class="_sltguests">
                                                <input type="text" class="_numcard @error('card_number') error_input @enderror" placeholder="1234 5678 9012 3456" wire:model.lazy="card_number">
                                                @error('card_number')
                                                    <div  class="_txterror">
                                                        <i class="fas fa-exclamation-circle icon1"></i> 
                                                        {{ $message }}
                                            ...
                                            <div class="_flfpc">
                                                <div class="block_date">
                                                    ...
                                                    <input type="date" class="_numcard @error('expiration') error_input @enderror" placeholder="MM/YY" wire:model.lazy="expiration">
                                                    @error('expiration')
                                                        <div  class="_txterror">
                                                            <i class="fas fa-exclamation-circle icon1"></i> 
                                                            {{ $message }}
                                                ...
                                                <div class="block_date">
                                                    ...
                                                    <input type="text" class="_numcard @error('cvv') error_input @enderror" placeholder="MM/YY" wire:model.lazy="cvv">
                                                    @error('cvv')
                                                        <div  class="_txterror">
                                                            <i class="fas fa-exclamation-circle icon1"></i> 
                                                            {{ $message }}
                                            ...
                                            <div class="_flfpc">
                                                <div class="block_date">
                                                    ...
                                                    <input type="text" class="_numcard @error('street_address') error_input @enderror" wire:model.lazy="street_address">
                                                ...
                                                <div class="block_date">
                                                    ...
                                                    <input type="text" class="_numcard @error('apt') error_input @enderror" wire:model.lazy="apt">
                                                    @error('apt')
                                                        <div  class="_txterror">
                                                            <i class="fas fa-exclamation-circle icon1"></i> 
                                                            {{ $message }}
