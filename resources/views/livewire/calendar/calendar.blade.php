        ...
        <div class="contCalendarVvoFlex">
            ...
            <div class="fx fx-fd-c ht-p100 borderCont">
                <div class="ifx pd-t28 mr-l16 mr-b9">
                    <button type="button" class="fright-tb js_hideMdlReservationTable iconFlecha">
                ...
                <div class="modal_block">
                    <div class="content_hidden-anhost" style="margin-bottom: 0;">
                        <div class="_goqbqk">
                            ...
                            <p class="_txtec mr-t16">Leave a private note as a reminder for this date. This is not shown to guests.</p>

                            <textarea class="_txta-modls" style="margin: 48px 0px 32px; resize: vertical; display: block;" rows="5"></textarea>
                        </div>
                    </div>
                </div>
