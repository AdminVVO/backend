            ...
            <div class="_z4lmgp">
                <div class="pn-r fx fx-fd-c wh-p100 ht-p100">
                    <div class="_2dcmym fx fx-ai-c fx-jc-sb">
                        <h2 class="h2-guests _txtcapit">messagesss</h2>
                                            ...
                                            <div class="fx fx-ai-c gp17">
                                                ...
                                                <div class="fx fx-fd-c wh-p100">
                                                    ...
                                                    <div class="fx fx-ai-c fx-jc-sb gp8">
                                                        ...
                                                        <span class="_txtec14 _txtcapit">{{ Carbon\CarbonImmutable::now()->sub( $element->message[0]->created_at )->calendar(); }}</span>
                                                    </div>
                                                    <p class="_txtec14 lh20 text_tm1">{{ Carbon\Carbon::parse( $element->listing->created_at, 'UTC')->locale('en')->isoFormat('ll') }} | {{ $element->listing->title }}</p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    {{--                     <div class="bx_msg_received active_msg_received">
                                            ...
                                            <div class="fx fx-fd-c wh-p100">
                                                <div class="fx fx-ai-c fx-jc-sb gp8">
                                                    <span class="_txteh16 _txtcapit">{{ $element->transmitter->id_user === Auth::id() ? $element->receiver->name : $element->transmitter->name }}</span>
