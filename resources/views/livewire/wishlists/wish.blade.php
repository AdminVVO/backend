<div class="content_location">
    <div class="flex_local-dates fx ht100v ow-h">
        <div class="content_location-width">
            <div class="content_view">
                <div class="fx fx-ai-c fx-fw-w fx-jc-sb mr-b24 gp12">
                    <a href="/wishlist" aria-label="Prev" class="circle__btn-cerrar btn-x_galls">
                        <span class="pr">
                            ...
                            <div class="_bef-places popup_add_guest_places">
                                <div class="fxfbwhmhbrzi">
                                    ...
                                    <div class="footer__btnmdl hrtop pd32">
                                        <button type="button" class="txtunder__ics xhidemdusr">Clear</button>
                ...
                <h2 class="h2-guests">{{ $name }}</h2>

                <div class="optionsmini fx-fw-w gp8 mr-t8 showfx743"></div>

                <div class="hidden_galerias mr-t40" style="height: auto;">
                    @if ($contentListing)
                            ...
                            <a href="{{ route('interna', $element['id_listings']) }}" class="content_galerias"
                                ...
                                <div class="slideshow-container">
                                    ...
                                    @if (Auth::check())
                                        @if (in_array($element['id_listings'], $wishlists))
                                            <button type="button" class="card_love icon_solid showFavorite"
                                    ...
                                    <div class="card_img">
                                        <img
                                            src="{{ URL::asset('storage/photos-listing/') . '/' . \App\Models\Listing\Listings::ListingFile($element['id_listings']) . '/' . $element['photos'][0]['name'] }}">
                                        <img
                                            src="{{ URL::asset('storage/photos-listing/') . '/' . \App\Models\Listing\Listings::ListingFile($element['id_listings']) . '/' . $element['photos'][1]['name'] }}">
                                        <img
                                            src="{{ URL::asset('storage/photos-listing/') . '/' . \App\Models\Listing\Listings::ListingFile($element['id_listings']) . '/' . $element['photos'][2]['name'] }}">
                                    </div>
                                ...
                                <div class="flex_info">
                                    ...
                                    <p class="total_local  ">
                                        ...
                                        night
                                        @if ($daysDiff != 0)
                                            <i class="far fa-long-arrow-right"></i> <span class="t">Total</span>
                                            <i class="fas fa-dollar-sign"></i>
                ...
                <div class="flex-centrado mr-ta pd-t24 pd-b24">
                    <div class="pagination"></div>
                </div>
            </div>
        </div>

        <div class="content_location-width hideblock1000" wire:ignore>
