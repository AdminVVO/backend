<form wire:submit.prevent="SubmitAddress" class="show_form_input">
    <div class="fx fx-fd-c" style="gap: 30px;">
        <div class="_flfpc disabled">
            <div class="txt-check-in">Country / Región</div>
            <input type="text" class="_numcard disabled_input @error('inputCountry') error_input @enderror" wire:model.defer="inputCountry">
            @error('inputCountry')
                <div  class="_txterror">
        ...
        <div class="_flfpc" style="gap: 30px;">
            <div class="block_date">
                ...
                <input type="text" class="_numcard _txtcapit @error('inputCity') error_input @enderror" wire:model.defer="inputCity">
                @error('inputCity')
                    <div  class="_txterror">
                        <i class="fas fa-exclamation-circle icon1"></i> 
                        {{ $message }}
            ...
            <div class="block_date">
                ...
                <input type="text" class="_numcard _txtcapit @error('inputState') error_input @enderror" wire:model.defer="inputState">
                @error('inputState')
                    <div  class="_txterror">
                        <i class="fas fa-exclamation-circle icon1"></i> 
                        {{ $message }}
        ...
        <div class="_flfpc">
            <div class="block_date">
                ...
                <input type="number" class="_numcard input_numberzipcode @error('inputZipcode') error_input @enderror" wire:model.defer="inputZipcode">
                @error('inputZipcode')
                    <div  class="_txterror">
                        <i class="fas fa-exclamation-circle icon1"></i> 
                        {{ $message }}
