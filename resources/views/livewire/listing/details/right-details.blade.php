<div class="content_resort_people">
    ...
    <div class="listing_details">
        <div class="content_listing_details">
            ...
            @if ( $stepBar == 'details' )
                @include('livewire.listing.details.indexBasic')
            @endif
            
           @if ( $stepBar == 'pricing' )
                @include('livewire.listing.details.indexPricing')
            @endif
            
            @if ( $stepBar == 'policies' )
                @include('livewire.listing.details.indexPolicies')
            @endif
...
{{--     <script>
        Livewire.hook('message.processed', (message, component) => {
            ...
            $(".clickInstantBookon").on("click", function(e) {
                window.livewire.emitTo('listing.details.instant-book', 'initComponent');
                animateTopModals();
