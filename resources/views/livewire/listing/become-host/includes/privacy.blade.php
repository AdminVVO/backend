                    ...
                    <div class="_ps-abs">
                        <div class="scroll_n">
                            <div class="_grid next">
                                <div class="_width">
                                    <input type="radio" id="place" name="guestshave" checked wire:model.defer="inputPrivacy" value="entire_place">
                                ...
                                <div class="_width">
                                    <input type="radio" id="privateroom" name="guestshave" wire:model.defer="inputPrivacy" value="private_room">
                                ...
                                <div class="_width">
                                    <input type="radio" id="sharedroom" name="guestshave" wire:model.defer="inputPrivacy" value="shared_room">
