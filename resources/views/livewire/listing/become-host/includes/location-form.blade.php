                    ...
                    <div class="options_form">
                        ...
                        <div class="fx fx-fd-c gp20">
                            <div class="_flfpc">
                                ...
                                <input type="text" class="_numcard @error('inputStreet') error_input @enderror"
                                    wire:model.defer="inputStreet">
                                @error('inputStreet')
                                    <div class="_txterror">
                            ...
                            <div class="_flfpc" style="gap: 20px;">
                                ...
                                <div class="block_date">
                                    ...
                                    <input type="text" class="_numcard @error('inputCity') error_input @enderror"
                                        wire:model.defer="inputCity">
                                    @error('inputCity')
                                        <div class="_txterror">
                                            <i class="fas fa-exclamation-circle icon1"></i>
                                            {{ $message }}
                            ...
                            <div class="_flfpc">
                                <div class="block_date">
                                    ...
                                    <input type="text" class="_numcard @error('inputRegion') error_input @enderror"
                                        wire:model.defer="inputRegion">
                                    @error('inputRegion')
                                        <div class="_txterror">
                                            <i class="fas fa-exclamation-circle icon1"></i>
                                            {{ $message }}
                            ...
                            <div class="_flfpc">
                                ...
                                <input type="text" class="_numcard @error('inputCountry') error_input @enderror"
                                    wire:model.defer="inputCountry">
                                @error('inputCountry')
                                    <div class="_txterror">
                                        <i class="fas fa-exclamation-circle icon1"></i>
                                        {{ $message }}
                        ...
                        <p class="_txtec16">We'll only share your address with guests who are booked as outlined in our
                            <a href="" class="_txtblu16">privacy policy</a>.</p>
                    </div>
                </div>
            </div>
        </div>
