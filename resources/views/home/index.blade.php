...
@section('css')
    ...
    <link href="{{ URL::asset('assets/css/owl.carousel.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('assets/css/owl.theme.default.min.css') }}" rel="stylesheet" type="text/css" />
...
@section('content')
    ...
    <div class="tabs entero">
        <div class="medio">
            @include('home.tabs-items')
            @include('home.tabs-select')
        </div>
    </div>
