    ...
    <div>
        ...
        <div class="entero section-places">
            <div class="medio">
                <div 
                    class="block_places"
                    v-click-outside="closeGuest"
                >
                    <h3>Places to stay</h3>
                    <div
                        class="book-form book-f_home"
                        :class="[ showGuest ? 'is-active' : '' ]" 
                    >
                        <MenuPlaces
...
<script>
    ...
    import MenuPlaces from '../components/home/MenuPlaces.vue'
    import MenuBefoPlaces from '../components/home/MenuBefoPlaces.vue'
    import TabsItems from '../components/home/TabsItems.vue'
    import TabsSelect from '../components/home/TabsSelect.vue'
