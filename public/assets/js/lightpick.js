...
(function (root, factory) {
  ...
  renderTopButtons = function(opts) {
    return '<div class="lightpick__toolbar">'
      + ''
      + '<span class="absclry"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="2" viewBox="0 0 20 2"><rect width="20" height="2" rx="1" fill="#00b5dd"/></svg></span>'
  ...
  Lightpick = function (options) {
    ...
    if (opts.footer) {
      ...
      if (opts.footer === true) {
        html += '<button type="button" class="lightpick__reset-action _1e5q4qoz"><div class="fx fx-ai-b lightpick__reset-action gp5"><span class="lightpick__reset-action">' + opts.locale.buttons.reset + '</span><img class="lightpick__reset-action" src="assets/img/icons/right-back.svg" alt=""></div></button>';
        html += '<div class="lightpick__footer-message"></div>';
        html += '<button type="button" class="lightpick__apply-action _1lerwp6l">' + opts.locale.buttons.apply + '</button>';
      } else {
        html += opts.footer;
      }
      html += '</div>';
