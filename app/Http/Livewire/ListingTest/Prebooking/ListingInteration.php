...
namespace App\Http\Livewire\ListingTest\Prebooking;
...
class ListingInteration extends Component
{
    ...
    {
        return view('livewire.listing-test.prebooking.listing-interation');
    }
    ...
    {      
        ...
        $this->emitTo('listing-test.right-details', 'reloadSubmit', 'prebooking');
