...
class Wish extends Component
{
    ...
    {
        $this->reset(['contentCoordinate', 'preLoadCoordinate', 'contentListing', 'wishlists', 'places']);
        $this->preLoadContent();
    ...
    {
        $this->reset(['contentCoordinate', 'preLoadCoordinate', 'contentListing', 'wishlists']);
        Wishlists::where(['user_id' => Auth::id(), 'name' => $this->name, 'listing_id' => $payload])->delete();
    ...
    public function preLoadContent()
    {
        ...
        $this->contentListing = Listings::select(
            ...
            ->join('listing_property_roomds', 'listings.id_listings', 'listing_property_roomds.listing_id')
