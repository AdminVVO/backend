...
class CountryPhoneSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $countries = [
            ...
            [ "name" => "Niue", "code" => "+683" ],
            [ "name" => "NorfolkIsland", "code" => "+672" ],
            [ "name" => "NorthernMarianaIslands", "code" => "+1670" ],
            [ "name" => "Norway", "code" => "+47" ],
            [ "name" => "Oman", "code" => "+968" ],
        ...
        DB::table('country_phones')->insert($countries);
    }
}
